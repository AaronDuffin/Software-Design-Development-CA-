...
public class Model {
    ...
    private ApartmentTableGateway gateway;
    ...
    private Model() {
        try {
            ...
            this.gateway = new ApartmentTableGateway(conn);
...
//                        "PHP MySQL", 80000.00));
    ...
    public List<Apartment> getApartments() {
        ...
        return (gateway.getApartments());
    }

    public boolean updateApartment(Apartment p) {
        return this.gateway.updateApartment(p);
    }

    public boolean deleteApartment(int deleteId) {
        return this.gateway.deleteApartment(deleteId);
    }
    ...
    public boolean addApartment(Apartment p) {


        return (gateway.insertApartment(p));
    }
